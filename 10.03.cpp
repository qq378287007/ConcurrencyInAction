...
extern log_info parse_log_line(string const &line);

using visit_map_type = unordered_map<string, unsigned long long>;

visit_map_type count_visits_per_page(vector<string> const &log_lines)
{
    ...
    return transform_reduce(
        execution::par, log_lines.begin(), log_lines.end(),
